...
import com.qinglan.sdk.server.platform.domain.*;
import com.qinglan.sdk.server.platform.domain.dto.*;
import com.qinglan.sdk.server.platform.utils.qq.JSONException;
import com.qinglan.sdk.server.platform.utils.qq.JSONObject;
import com.qinglan.sdk.server.platform.utils.qq.OpenApiV3;
import com.qinglan.sdk.server.platform.utils.qq.OpensnsException;
import com.qinglan.sdk.server.Constants;
import com.qinglan.sdk.server.platform.service.PlatformService;
import com.qinglan.sdk.server.platform.service.PlatformUtilsService;
import com.qinglan.sdk.server.platform.utils.PlatformStatsLogger;
import com.sun.org.apache.xerces.internal.parsers.DOMParser;
import com.uudev.payment.cloud.util.DesUtils;
import com.qinglan.sdk.server.platform.utils.HMACSHA1;
import com.qinglan.sdk.server.platform.utils.HMacMD5;
import com.qinglan.sdk.server.platform.utils.fansdk.FansdkSigleUtils;
import com.qinglan.sdk.server.platform.utils.fansdk.UOrder;
import com.qinglan.sdk.server.platform.utils.hongshouzhi.HongShouZhiUtil;
...
import com.qinglan.sdk.server.platform.utils.qqmssdk.MsOpenApiV3;
import com.qinglan.sdk.server.platform.utils.quicksdk.IOSDesUtil;
import com.qinglan.sdk.server.platform.utils.quicksdk.QuickXmlBean;
import com.qinglan.sdk.server.platform.utils.quicksdk.XmlUtils;
import com.qinglan.sdk.server.platform.utils.xiao7.VerifyXiao7;
...
import com.qinglan.sdk.server.domain.Platform;
import com.qinglan.sdk.server.domain.PlatformGame;
import com.qinglan.sdk.server.platform.domain.MMYPayResult;
import com.qinglan.sdk.server.platform.domain.UcGameResult;
import com.qinglan.sdk.server.platform.domain.YaoyueResult;
import com.qinglan.sdk.server.platform.domain.YouleResult;
...
public class PlatformServiceImpl implements PlatformService {
    ...
    @Override
    public String verifyYaoyue(YaoyueResult zhidian) {
    ...
    @Override
    public String verifyUcSession(UcGameSession ucSession) {
        if (StringUtils.isEmpty(ucSession.getAppId()) || StringUtils.isEmpty(ucSession.getPlatformId())
                || StringUtils.isEmpty(ucSession.getSid()) || StringUtils.isEmpty(ucSession.getGameId())) {
            return "";
        }
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(Integer.valueOf(ucSession.getPlatformId()), Long.valueOf(ucSession.getAppId()));
        ...
        mapGame.put("gameId", ucSession.getGameId());
    ...
    @Override
    public String verifyUcGame(HttpServletRequest request) {
        try {
            ...
            if (StringUtils.isEmpty(stringBuffer.toString())) return "FAILURE";
            //记录日志
            PlatformStatsLogger.info(PlatformStatsLogger.UC, stringBuffer.toString());
            UcGameResult ucgameObj = JsonMapper.toObject(stringBuffer.toString(), UcGameResult.class);
            if (ucgameObj.getData() == null || StringUtils.isEmpty(ucgameObj.getSign())) return "FAILURE";

            //note穿透 OrderId
            Order order = orderService.getOrderByOrderId(ucgameObj.getData().getCpOrderId());
            if (order == null) return "FAILURE";
            PlatformGame platformGame = basicRepository.getByPlatformAndAppId(order.getPlatformId(), order.getAppId());
            if (platformGame == null) return "FAILURE";
            String apiKey = platformGame.getConfigParamsList().get(0);
            Map<String, Object> map = new HashMap<String, Object>();
            ...
            PlatformStatsLogger.error(PlatformStatsLogger.UC, request.getQueryString(), "uc verifyUcGame error:" + e);
        }
        return "FAILURE";
    }
    ...
    public String verifyXiaomiSession(XiaomiSession xiaomiSession) {
        ...
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(Integer.valueOf(xiaomiSession.getPlatformId()), Long.valueOf(xiaomiSession.getZdappId()));
        if (platformGame == null) return "";
    ...
    public String verifyQihooSession(QihooSession qihooSession) {
        ...
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(Integer.valueOf(qihooSession.getPlatformId()), Long.valueOf(qihooSession.getZdappId()));
        if (platformGame == null)
            return "";
    ...
    public String verifyQihoo(HttpServletRequest request) {
        ...
        try {
            ...
            if (order == null) return "not mybatis order";
    ...
    public String verifyBaiduSession(BaiduSession baiduSession) {
        ...
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(Integer.valueOf(baiduSession.getPlatformId()), Long.valueOf(baiduSession.getZdappId()));
        if (platformGame == null)
            return "";
        String secretKey = platformGame.getConfigParamsList().get(0);
        String verifySessionUrl = platformGame.getConfigParamsList().get(1);
    ...
    public String verifyBaidu(HttpServletRequest request) {
        ...
        try {
            ...
            if (MD5.encode(strSign.toString()).equals(sign)) {
                @SuppressWarnings("unchecked")
                HashMap<String, Object> objMap = JsonMapper.toObject(com.qinglan.sdk.server.common.Base64.decode(content), HashMap.class);
    ...
    public String verifyAnzhiSession(AnzhiSession anzhiSession) {
        ...
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(Integer.valueOf(anzhiSession.getPlatformId()), Long.valueOf(anzhiSession.getZdappId()));
        if (platformGame == null)
            return "";
        ...
        params.put("sign", com.qinglan.sdk.server.common.Base64.encode(appkey + anzhiSession.getAccount() + anzhiSession.getSid()) + "appsecret");
    ...
    public String verifyAnzhi(HttpServletRequest request) {
        ...
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(1004, Long.valueOf(id));
        if (platformGame == null) {
            return "error";
        }
        ...
        try {
            AnzhiPayResult back = JsonMapper.toObject(data, AnzhiPayResult.class);
            Order order = orderService.getOrderByOrderId(back.getCpInfo());
            if (order == null) {
                return "error";
            }
            platformGame = basicRepository.getByPlatformAndAppId(order.getPlatformId(), order.getAppId());
            if (platformGame == null) {
                return "error";
            }
            if (1 == back.getCode()) {
    ...
    public String verifyWdj(HttpServletRequest request) {
        ...
        try {
            WdjPayResult callback = JsonMapper.toObject(content, WdjPayResult.class);
            if (null == callback) {
                return "fail";
            }
    ...
    public String verifyDownjoy(HttpServletRequest request) {
        ...
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(
                order.getPlatformId(), order.getAppId());
        if (platformGame == null) {
            return "failure";
        }
    ...
    public String verifySougouSession(SougouSession sougouSession) {
        ...
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(Integer.valueOf(sougouSession.getPlatformId()), Long.valueOf(sougouSession.getZdappId()));
        if (platformGame == null)
            return "";
    ...
    public String verifyKupai(HttpServletRequest request) {
        ...
        try {
            KupaiPayResult callback = JsonMapper.toObject(transdata, KupaiPayResult.class);
    ...
    public String verifyOppoSession(OppoSession session) {
        ...
        try {
            ...
            String sign = URLEncoder.encode(String.valueOf(com.qinglan.sdk.server.common.Base64.encode(HMACSHA1.HmacSHA1Encrypt(baseStr.toString(), appSecret + "&"))), "UTF-8");
    ...
    public String verifyAppchina(HttpServletRequest request) {
        ...
        AppchinaPayResult back = JsonMapper.toObject(transdata, AppchinaPayResult.class);
    ...
    public String signHTCPayContent(HttpServletRequest request) {
        ...
        PlatformGame platform = basicRepository.getByPlatformAndAppId(Integer.valueOf(platformId), Long.valueOf(zdappId));
    ...
    public String verifyHTCSession(HTCSession session) {
        ...
        PlatformGame platform = basicRepository.getByPlatformAndAppId(Integer.valueOf(session.getPlatformId()), Long.valueOf(session.getZdappId()));
    ...
    public String verifyHTC(HttpServletRequest request) {
        try {
            ...
            HTCPayResult back = JsonMapper.toObject(orderInfo, HTCPayResult.class);
    ...
    public String meizuPaySign(HttpServletRequest request) {
        ...
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(Integer.valueOf(params.get("platformId").toString()), Long.valueOf(params.get("zdappId").toString()));
        if (null == platformGame) {
            result.put("code", "1");
            return JsonMapper.toJson(result);
        }
    ...
    public String verifyLenovo(HttpServletRequest request) {
        ...
        try {
            ...
            LenovoPayResult back = JsonMapper.toObject(transdata, LenovoPayResult.class);
            if (null == back) {
                return "FAILURE";
            }
    ...
    public String verifyQixiazi(HttpServletRequest request) {
        ...
        try {
            QixiaziPayResult back = JsonMapper.toObject(transdata, QixiaziPayResult.class);
    ...
    public String verifyKuaiyong(HttpServletRequest request) {
        ...
        try {
            String publicKey = platformGame.getConfigParamsList().get(2);
            String data = new String(RSAEncrypt.decrypt(RSAEncrypt.loadPublicKeyByStr(publicKey), com.qinglan.sdk.server.common.Base64.decodeToByteArray(notify_data)));
    ...
    public String verifyTencent(HttpServletRequest request) {
        ...
        logger.debug(String.format("-------------------------------appid=%s,platform=%d,gameCoinRation=%d,amount=%d", platformGame.getAppId(), platformGame.getPlatformId(), gameCoinRatio, order.getAmount()));
...
//                result.put("msg", msg);
    ...
    public String verifyLiebaoSession(LiebaoSession session) {
        ...
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(Integer.valueOf(session.getPlatformId()), Long.valueOf(session.getYgAppId()));
        if (platformGame == null) {
            result.put("status", "1");
    ...
    public String verifyLeshanSession(LeshanSession session) {
        logger.debug("verify 07073 dto params : " + session.toString());
        if (StringUtils.isBlank(session.getZdappId()) || StringUtils.isBlank(session.getPlatformId())
        ...
        try {
            ...
            logger.error("verify 07073 dto error", e);
            return "";
        }
    }
    ...
    public String atetPaypoing(HttpServletRequest request) {
        ...
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(Integer.valueOf(platformId), Long.valueOf(appId));
    ...
    public String verifyAtet(HttpServletRequest request) {
        ...
        AtetPayResult back = JsonMapper.toObject(transdata, AtetPayResult.class);
        String orderId = back.getExOrderNo();
        Order order = orderService.getOrderByOrderId(orderId);
        if (null == order) {
            return "fail";
    ...
    public String verifyHaimaSession(HaimaSession session) {
        ...
        try {
            ...
            logger.error("verify haima dto error", e);
            result.put("code", "2");
        }
        return JsonMapper.toJson(result);
    }
    ...
    public String verifyPengyouwan(HttpServletRequest request) {
        ...
        try {
            ...
            PengyouwanPayResult back = JsonMapper.toObject(sb.toString(), PengyouwanPayResult.class);
            if (null == back) {
                result.put("ack", "101");
    ...
    public String verifyLehihiSession(LehihiSession session) {
        ...
        try {
            ...
            logger.error("verify lehihi dto error", e);
            return "";
        }
    }
    ...
    public String verifyYouleSession(YouleSession session) {
        ...
        try {
            ...
            logger.error("verify youle dto error", e);
            return "";
        }
    }

    @Override
    public String verifyYoule(YouleResult callback) {
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public String qbaoPaySign(HttpServletRequest request) {
        ...
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(Integer.valueOf(platformId), Long.valueOf(zdappId));
        if (platformGame == null) {
            result.put("code", "1");
            result.put("msg", "params error");
            result.put("payCode", "");
    ...
    public String verifyTtSession(TtSession ttSession) {
        ...
        try {
            ...
            PlatformGame platformGame = basicRepository.
                    getByPlatformAndAppId(Integer.valueOf(ttSession.getPlatformId()), Long.valueOf(ttSession.getYgAppId()));
            if (platformGame == null) {
                head.put("result","1");
    ...
    public String verifyShunwangSession(HttpServletRequest request) {
        ...
        try {
            PlatformGame platformGame = basicRepository.getByPlatformAndAppId(Integer.valueOf(request.getParameter("platformId")), Long.valueOf(request.getParameter("zdappId")));
            if (platformGame == null) {
                return "";
            }
...
//			result.put("code", re.get(result.get("msgId")));
            ...
            logger.error("verify Shun wang dto error", e);
            result.put("code", "1");
            result.put("msg", "服务器异常");
            return JsonMapper.toJson(result);
        }
    ...
    @Override
    public String verifyLewan(HttpServletRequest request) throws IOException {
        String data = request.getParameter("data");
        ...
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(1104, Long.parseLong(appid));
...
//            out.println("sign is not pass");
        ...
        TreeMap<String, String> map = mapper.readValue(realData, new TypeReference<TreeMap<String, String>>() {
        });
    ...
    public String getWuxiandongliPaycode(HttpServletRequest request) {
        ...
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(Integer.parseInt(platformId), Long.parseLong(appId));
        if (platformGame == null) {
            resultMap.put("code", 1);
    ...
    public String verifyQuick(HttpServletRequest request) {
        ...
        String appid = request.getParameter("appid");
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(19, Long.parseLong(appid));
        if (platformGame == null) {
            return "error";
        }
    ...
    public String verifyYijie(HttpServletRequest request) {
        ...
        String appid = request.getParameter("appid");
        PlatformGame platformGame = basicRepository.getByPlatformAndAppId(17, Long.parseLong(appid));
        if (platformGame == null) {
            return "error";
        }
        String localKey = platformGame.getConfigParamsList().get(1).trim();
