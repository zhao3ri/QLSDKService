...
import com.qinglan.sdk.server.platform.fansdk.FansdkSigleUtils;
import com.qinglan.sdk.server.platform.fansdk.UOrder;
import com.qinglan.sdk.server.platform.hongshouzhi.HongShouZhiUtil;
import com.qinglan.sdk.server.platform.lewan.util.encrypt.AES;
import com.qinglan.sdk.server.platform.lewan.util.encrypt.EncryUtil;
import com.qinglan.sdk.server.platform.lewan.util.encrypt.RSA;
import com.qinglan.sdk.server.platform.qq.JSONObject;
import com.qinglan.sdk.server.platform.qq.OpenApiV3;
import com.qinglan.sdk.server.platform.qq.OpensnsException;
import com.qinglan.sdk.server.platform.qqmssdk.MsOpenApiV3;
import com.qinglan.sdk.server.platform.quicksdk.IOSDesUtil;
...
import com.qinglan.sdk.server.release.application.platform.log.PlatformStatsLogger;
...
import com.qinglan.sdk.server.release.domain.platform.MMYPayResult;
import com.qinglan.sdk.server.release.domain.platform.UcGameCallback;
...
public class PlatformServiceImpl implements PlatformService {
    ...
    public String verifyUcGame(HttpServletRequest request) {
        try {
            ...
            UcGameCallback ucgameObj = JsonMapper.toObject(stringBuffer.toString(), UcGameCallback.class);
