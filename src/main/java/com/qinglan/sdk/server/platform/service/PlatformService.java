...
public interface PlatformService {
	...
	String verifyYaoyue(YaoyueResult zhidian);
	
	String verifyUcGame(HttpServletRequest request);
	
	String verifyUcSession(UcGameSession ucSession);
	...
	String verifyYoule(YouleResult callback);
	...
	String verifyLewan(HttpServletRequest request) throws IOException;
