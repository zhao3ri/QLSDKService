package com.qinglan.sdk.server.platform.utils.qqmssdk;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.qinglan.sdk.server.platform.utils.qq.*;
...
public class MsOpenApiV3 {
	private static final Logger logger = LoggerFactory.getLogger(MsOpenApiV3.class);
	/**
	 * 构造函数
	 *
	 * @param appid
	 ...
	 *            应用的密钥
	 */
	public MsOpenApiV3(String appid, String appkey) {
		this.appid = appid;
		this.appkey = appkey;
	}

	public MsOpenApiV3(String appid, String appkey, String serverName) {
		this.appid = appid;
		this.appkey = appkey;
...
//		params.put("appid", this.appid);
		...
		// 计算签名
		String signScriptName = "/v3"+scriptName;
...
*/
	...
	public String api_msdk(String scriptName, HashMap<String, String> qs,
		...
		String params_json = mapper.writeValueAsString(params);
